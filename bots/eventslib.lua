...
function object:oncombatevent(EventData)
	...
	elseif EventData.Type == "Item" then
		...
		elseif EventData.InflictorName == core.tpStoneDef:GetName() then
			--BotEcho("Port used!")
			behaviorLib.bLastPortResult = false
		end
	elseif EventData.Type == "State" or EventData.Type == "Buff" then
		if core.runesOfBlightDef ~= nil and EventData.StateName == core.runesOfBlightDef.stateName then
			--BotEcho("Runes of Blight applied")
			core.runesOfBlightDef.expireTime = curTimeMS + EventData.StateDuration
		elseif core.healthPotDef ~= nil and EventData.StateName == core.healthPotDef.stateName then
			--BotEcho("health pot applied")
			core.healthPotDef.expireTime = curTimeMS + EventData.StateDuration
		end
